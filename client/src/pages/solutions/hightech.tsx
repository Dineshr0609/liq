...
import {
  Factory, CheckCircle, ArrowRight, ArrowLeft
} from "lucide-react";

export default function HighTechSolution() {
  const industry = {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-orange-700 to-orange-900">
