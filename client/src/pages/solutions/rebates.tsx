...
export default function RebatesSolution() {
  const flow = {
    ...
    description: "Transform rebate management from spreadsheet chaos to contract-driven precision. Automate eligibility checks, validate claims, and generate accurate accruals.",
    benefits: [
      "Eliminate manual eligibility checking with automated rules",
      "Validate every claim against contract terms before approval",
      "Generate accurate accruals for financial close",
      "Maintain complete audit trail from claim to settlement",
    ],
  };
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
                ...
                <Card key={idx} className="border-orange-200 dark:border-orange-900 bg-orange-50 dark:bg-orange-950/20">
                  <CardContent className="p-4 flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-orange-100 dark:bg-orange-950 flex items-center justify-center flex-shrink-0 mt-0.5">
                      <span className="text-orange-700 dark:text-orange-500 text-sm font-bold">{idx + 1}</span>
                    </div>
      ...
      <section className="py-16 bg-gradient-to-r from-green-600 to-emerald-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Automate Your Rebate Management?</h2>
