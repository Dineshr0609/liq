...
export default function DistributorProgramsSolution() {
  const flow = {
    ...
    description: "Manage complex distributor relationships with contract-driven automation. From rebate calculations to chargeback processing, ensure every transaction aligns with your agreements.",
    benefits: [
      "Automate rebate calculations based on contract terms",
      "Validate POS data against eligibility rules",
      "Generate accurate accruals for financial close",
      "Create audit-ready settlement documentation",
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-orange-50 to-cyan-50 dark:from-slate-950 dark:via-stone-950/20 dark:to-cyan-950/20 pt-28 pb-20">
      ...
      <section className="py-16 bg-gradient-to-r from-orange-700 to-cyan-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Streamline Your Distributor Programs?</h2>
