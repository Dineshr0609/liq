...
export default function LicensingSolution() {
  const industry = {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-purple-50 to-orange-50 dark:from-slate-950 dark:via-purple-950/20 dark:to-stone-950/20 pt-28 pb-20">
      ...
      <section className="py-16 bg-gradient-to-r from-purple-600 to-orange-800">
