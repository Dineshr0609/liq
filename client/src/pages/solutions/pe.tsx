...
export default function PeSolution() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 dark:from-slate-950 dark:via-orange-950/20 dark:to-amber-950/20 pt-28 pb-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-orange-400/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-amber-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        <div className="container mx-auto px-4 relative z-10">
          <Link href="/solutions">
            <span className="inline-flex items-center gap-2 text-orange-600 hover:text-orange-700 mb-6 cursor-pointer">
