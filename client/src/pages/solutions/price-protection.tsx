...
import {
  Shield, CheckCircle, ArrowRight, ArrowLeft
} from "lucide-react";

export default function PriceProtectionSolution() {
  const flow = {
    ...
    description: "Manage price protection claims and chargebacks with contract-driven precision. Validate claims against agreed terms and maintain complete audit trails.",
    benefits: [
      "Validate price protection claims against contract terms",
      "Automate credit and settlement calculations",
      "Reduce disputes with transparent verification",
      "Build audit-ready documentation for every claim",
    ],
  };
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-amber-50 to-orange-50 dark:from-slate-950 dark:via-amber-950/20 dark:to-orange-950/20 pt-28 pb-20">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-1/4 w-96 h-96 bg-amber-400/10 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-orange-400/10 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>

        <div className="container mx-auto px-4 relative z-10">
          <Link href="/solutions">
            <span className="inline-flex items-center gap-2 text-amber-600 hover:text-amber-700 mb-6 cursor-pointer">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {flow.items.map((item, idx) => (
                <Card key={idx} className="border-amber-200 dark:border-amber-800 bg-amber-50 dark:bg-amber-950/20">
      ...
      <section className="py-16 bg-gradient-to-r from-amber-600 to-orange-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Streamline Price Protection?</h2>
